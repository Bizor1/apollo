...
import pic from "../images/wp10420020.jpg"
...
export default function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (data?.tokenAuth.success === false) {
      console.log("not loaded");
      // console.log(data)
    } else if (data?.tokenAuth.success === true) {
      ...
      console.log("TR", token, refresh);
      // console.log("from local",localStorage.getItem("user"))

      if (localStorage.getItem("user") === data.tokenAuth["user"]["username"]) {
